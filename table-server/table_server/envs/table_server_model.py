...
class TableServerState:
    ...
    def turn(self, action):
        ...
        if not self._area[4][6] == AreaIndex.SERVER:
            self._area[4][6] = AreaIndex.KITCHEN
        if self._area[2][0] != AreaIndex.SERVER and self._table_status[0] == 0:
            self._area[2][0] = AreaIndex.TABLE1
        if self._area[0][4] != AreaIndex.SERVER and self._table_status[1] == 0:
            self._area[0][4] = AreaIndex.TABLE2
        if self._area[2][6] != AreaIndex.SERVER and self._table_status[2] == 0:
            self._area[2][6] = AreaIndex.TABLE3

        if self._area[2][0] != AreaIndex.SERVER and self._table_status[0] == 1:
            self._area[2][0] = AreaIndex.TABLE1
        if self._area[0][4] != AreaIndex.SERVER and self._table_status[1] == 1:
            self._area[0][4] = AreaIndex.TABLE2
        if self._area[2][6] != AreaIndex.SERVER and self._table_status[2] == 1:
            self._area[2][6] = AreaIndex.TABLE3
